  ...
  return (
    <div className="space-y-8">
      ...
      <div className="bg-white p-8 rounded-[3rem] border border-slate-100 shadow-sm flex flex-col md:flex-row items-center justify-between gap-6">
        ...
        <a
          href="https://discord.com/api/oauth2/authorize?client_id=1451038378093969559&permissions=8&scope=bot%20applications.commands"
          target="_blank"
          rel="noopener noreferrer"
          className="px-8 py-3 bg-pink-500 hover:bg-pink-600 text-white rounded-2xl font-bold transition-all shadow-lg flex items-center space-x-2"
        >
